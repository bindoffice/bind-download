...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "mail-name": "BindMail 邮箱",
      "mail-ver": "极速 · 安全 · 智能邮件客户端",
      "mail-desc": "多账号统一管理，智能分类，重要邮件实时提醒。垃圾邮件零打扰，让每一封邮件都更快到达。",
      "mail-f1": "多账号聚合 · 一键切换",
      "mail-f2": "智能分类 · 重要邮件提醒",
      "mail-f3": "智能垃圾过滤 · 零打扰",
      "meet-name": "BindMeet 会议",
      "meet-ver": "高清 · 流畅 · 多人视频会议",
      "meet-desc": "一键发起高清视频会议，屏幕共享、实时字幕与 AI 纪要全程陪伴。智能降噪与弱网自适应，任何网络环境都清晰流畅。",
      "meet-f1": "高清视频会议 · 支持多人",
      "meet-f2": "屏幕共享 · AI 实时字幕纪要",
      "meet-f3": "智能降噪 · 弱网自适应",
      "android-download": "Android 下载",
      "ios-download": "iOS 下载",
      "qr-btn": "查看下载二维码",
      "app-foot": "支持 Android 8.0+ / iOS 13+",
      "app-tag": "官方渠道",
      "feat-title": "为什么选择 BindOffice",
      "feat-sub": "企业级安全能力，个人级使用体验",
      "feat1-title": "极速稳定",
      "feat1-desc": "全球节点加速，邮件秒级送达；会议自适应码率，弱网环境同样清晰流畅。",
      "feat2-title": "全端同步",
      "feat2-desc": "手机、平板、电脑多端实时同步，邮件、会议与日程无缝衔接，随时随地办公。",
      "footer-tagline": "让每一封邮件更快，让每一场会议更清晰。",
      "footer-rights": "· 保留所有权利",
      "modal-title-mail": "扫码下载 BindMail 邮箱",
      "modal-title-meet": "扫码下载 BindMeet 会议",
    ...
    en: {
      ...
      "stat-uptime": "Uptime",
      "stat-response": "Avg. Response",
      "stat-security": "Security 24/7",
      ...
      "meet-desc": "Start HD video meetings in one tap, with screen sharing, live captions, and AI meeting notes. Smart noise cancellation and adaptive bitrate keep you clear on any network.",
      "meet-f1": "HD video meetings · Multi-party",
      "meet-f2": "Screen sharing · AI captions & notes",
      ...
      "app-foot": "Supports Android 8.0+ / iOS 13+",
      "app-tag": "Official",
      "feat-title": "Why BindOffice",
      "feat-sub": "Enterprise-grade reliability, consumer-grade experience",
      "feat1-title": "Fast & Stable",
      "feat1-desc": "Global acceleration delivers email in seconds; adaptive bitrate keeps meetings smooth even on weak networks.",
